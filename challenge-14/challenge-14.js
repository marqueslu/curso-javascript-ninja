(function(){
    ...
    */
    ...
    var name = ['Lu', 'cas']
    var namep = name.reduce(function(acumulado, atual, index, aray){
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight(function(acumulado, atual, index, aray){
    ...
    */
    ...
    if(numberObjects.indexOf({number: 2}) > -1){
        console.log('Existem um objeto {number : 2} em numberObjects!');
    }else{
